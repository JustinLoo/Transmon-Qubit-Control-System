...
$$
\left( -4E_C \frac{d^2}{d\phi^2} - E_J \cos(\phi) \right) \psi_n(\phi) = E_n \psi_n(\phi) \quad  \quad \rightarrow \quad \quad
...
we can calearly see that every function parameter clearly maps onto our creation of the transmonin scqvits. we know know behind the scenese what the math is doing
