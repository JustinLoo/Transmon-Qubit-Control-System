...
Equation 1 (plug in $n = -1$):

```math
4E_C(-1)^2 c_{-1} - \frac{E_J}{2} (0 + c_{0}) = E c_{-1}$$Equation 2 (plug in $n = 0$):$$4E_C(0)^2 c_{0} - \frac{E_J}{2} (c_{-1} + c_{1}) = E c_{0}$$Equation 3 (plug in $n = 1$):$$4E_C(1)^2 c_{1} - \frac{E_J}{2} (c_{0} + 0) = E c_{1}
```
